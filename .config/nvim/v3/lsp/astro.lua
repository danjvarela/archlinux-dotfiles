...
return {
	cmd = {
		vim.fs.joinpath(vim.fn.stdpath("data"), "mason", "bin", "astro-ls"),
		"--stdio",
	},
	filetypes = { "astro" },
	...
	before_init = function(_, config)
      ...
      vim.notify("Resolved TypeScript TSDK: " .. util.get_typescript_server_path(config.root_dir), vim.log.levels.DEBUG)
		end
	end,
}
