...
vim.opt.guicursor = "" -- chubby cursor
vim.opt.foldlevel = 999 -- unfold everything by default
vim.opt.conceallevel = 1 -- some markdown thingy
vim.opt.wrap = true -- wrap by default
